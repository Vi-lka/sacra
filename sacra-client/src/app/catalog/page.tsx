...
import ErrorHandler from "@/custom-components/ui/ErrorHandler";
import { Filters } from "@/custom-components/ui/Filters";
import ImgText from "@/custom-components/ui/ImgText";
import PaginationControls from "@/custom-components/ui/PaginationControls";
import SearchField from "@/custom-components/ui/SearchField";
import Sort from "@/custom-components/ui/Sort";
...
export default async function Catalog({
    ...
    try {
        await getObjects(Number(page), Number(per), sort, search);
    } catch (error) {
        return (
          <ErrorHandler 
            error={error} 
    ...
    const dataResult = await getObjects(Number(page), Number(per), sort, search);
